  ...
  return (
    <nav className="flex justify-between items-center px-4 py-3 bg-black/20">
      <div className="pl-14 flex items-center gap-1">
        ...
        <h4
          className="inline-block align-middle text-3xl font-bold cursor-pointer bg-gradient-to-br from-[rgb(134,32,194)] to-gray-100 bg-clip-text text-transparent"
        >
          GameHub
        </h4>
      </div>
      ...
      <ul className="flex items-center gap-9 list-none">
        {["Games", "Tournaments", "Community", "Streams"].map((label) => (
          <li key={label}>
            <Link
