  ...
  return (
    <>
      <main className="relative w-full overflow-hidden h-[80vh]">
        ...
        <div 
          className="absolute top-[40%] left-[40%] w-[200px] h-[200px] rounded-full opacity-20 -translate-x-1/2 -translate-y-1/2 z-20"
          style={{
        ...
        ></div>
        <div 
          className="absolute top-[55%] left-[60%] w-[200px] h-[200px] rounded-full opacity-20 -translate-x-1/2 -translate-y-1/2 z-20"
          style={{
        ...
        <div className="absolute top-[30%] left-1/2 -translate-x-1/2 flex flex-col justify-center items-center text-center max-w-4xl w-full px-4 z-30">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-6">
            <Link href="/games">
              <button className="px-4 py-2 rounded-lg border-2 border-[rgb(134,32,194)] bg-gradient-to-r from-[rgb(134,32,194)] via-[rgb(208,64,194)] to-[rgb(219,10,136)] cursor-pointer transition-all duration-200 text-xl text-white font-bold w-[200px] h-[75px] hover:shadow-[0px_10px_25px_rgb(94,34,114)] hover:scale-105">
                Explore Games
              </button>
            </Link>
